...
return quarry_management.frontend.api.fetch_json((""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(quarry_management.frontend.api.api_url)+"/revenue-from-to"),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"method","method",55703592),"POST",new cljs.core.Keyword(null,"headers","headers",-835030129),({"Content-Type": "application/json"}),new cljs.core.Keyword(null,"body","body",-2049205669),JSON.stringify(({"from": from, "to": to}))], null)).then(callback).catch((function (p1__12069_SHARP_){
return console.error("Error calculating revenue:",p1__12069_SHARP_);
}));
});
