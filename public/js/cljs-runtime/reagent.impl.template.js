...
var G__21996 = o;
reagent.impl.template.goog$module$goog$object.set(G__21996,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__21997 = o;
reagent.impl.template.goog$module$goog$object.set(G__21997,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22024__i < G__22024__a.length) {G__22024__a[G__22024__i] = arguments[G__22024__i + 0]; ++G__22024__i;}
  args = new cljs.core.IndexedSeq(G__22024__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22025);
...
var G__21998 = props;
var G__21998__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21998,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21998);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21998__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21999 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21999,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21999;
}
})(),id_class);
...
var temp__5823__auto___22028 = (function (){var and__5140__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___22028)){
var d_22029 = temp__5823__auto___22028;
if((d_22029 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22029.s}));
} else {
...
var G__22000 = (cljs.core.count(argv) - first_child);
switch (G__22000) {
case (0):
...
var vec__22001 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22001,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22001,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22001,(2),null);
...
var key_22037 = temp__5827__auto___22035;
(jsprops.key = key_22037);
}
...
var temp__5827__auto___22039 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22039 == null)){
} else {
var key_22042 = temp__5827__auto___22039;
(jsprops.key = key_22042);
}
...
var key_22046 = temp__5827__auto___22043;
(jsprops.key = key_22046);
}
...
var temp__5827__auto___22047 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___22047 == null)){
} else {
var key_22048 = temp__5827__auto___22047;
(jsprops.key = key_22048);
}
...
var temp__5827__auto___22057 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22057 == null)){
} else {
var key_22058 = temp__5827__auto___22057;
(jsprops.key = key_22058);
}
...
var temp__5827__auto___22059 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22059 == null)){
} else {
var key_22060 = temp__5827__auto___22059;
(jsprops.key = key_22060);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22005_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22005_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22007 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22007,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22007,(1),null);
...
break;
default:
var G__22067 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22068 = compiler;
v = G__22067;
compiler = G__22068;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22017 = (function (opts,id,fn_to_element,parse_fn,meta22018){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22017.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22019,meta22018__$1){
var self__ = this;
var _22019__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22017(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22018__$1));
}));

(reagent.impl.template.t_reagent$impl$template22017.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22019){
var self__ = this;
var _22019__$1 = this;
return self__.meta22018;
}));

(reagent.impl.template.t_reagent$impl$template22017.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22017.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22017.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22017.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22017.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22017.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22018","meta22018",-2125435003,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22017.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22017.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22017");

(reagent.impl.template.t_reagent$impl$template22017.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template22017");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22017.
 */
reagent.impl.template.__GT_t_reagent$impl$template22017 = (function reagent$impl$template$__GT_t_reagent$impl$template22017(opts,id,fn_to_element,parse_fn,meta22018){
return (new reagent.impl.template.t_reagent$impl$template22017(opts,id,fn_to_element,parse_fn,meta22018));
});
...
return (new reagent.impl.template.t_reagent$impl$template22017(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
